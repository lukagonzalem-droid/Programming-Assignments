...
def main(page: ft.Page):
    ...
    playlist = [
        ...
        {"title": "Si Tu Prescencia Conmigo No Va", "artist": "Oasis Ministry", "album": "Si Tu Prescencia Conmigo No Va", "file": "Songs/situprescenciaconmigonova.mp3", "cover": "Covers/situprescenciaconmigonova.jpeg"},
